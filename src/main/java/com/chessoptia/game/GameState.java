...
import com.chessoptia.core.BitboardState;
import com.chessoptia.model.Color;
import com.chessoptia.model.Move;
import com.chessoptia.rules.MoveGenerator;
...
public final class GameState {
    ...
    private boolean isInsufficientMaterial() {
        for (Color c : Color.values()) {
            if (current.getBitboard(c, com.chessoptia.model.Piece.PAWN) != 0) return false;
            if (current.getBitboard(c, com.chessoptia.model.Piece.ROOK) != 0) return false;
            if (current.getBitboard(c, com.chessoptia.model.Piece.QUEEN) != 0) return false;
        }
